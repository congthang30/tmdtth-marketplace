...
export type ShopCatalog = { shop: { id: string; idString: string; shopName: string; slug: string; description: string | null; avatarUrl: string | null; province: string | null; createdAt: string; operationMode: 'Open' | 'PausedUntil' | 'PausedIndefinitely'; pauseStartsAt: string | null; pauseEndsAt: string | null; isAcceptingOrders: boolean }; categories: ShopCategory[]; products: ShopCatalogProduct[]; meta: { page: number; limit: number; total: number; totalPages: number } };
