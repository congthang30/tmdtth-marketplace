...
export type SellerShopCategory = { id: string; idString: string; parentShopCategoryId: string | null; categoryName: string; slug: string; description: string | null; imageUrl: string | null; sortOrder: number; isActive: boolean; productIds: string[] };
export type ShopCategoryBody = { categoryName: string; parentShopCategoryId?: string; description?: string; imageUrl?: string; sortOrder?: number; isActive?: boolean };
